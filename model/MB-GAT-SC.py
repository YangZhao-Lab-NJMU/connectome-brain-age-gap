"""
MB-GAT-SC: Multi-modal Brain Graph Attention Network with SC
...
class MB_GAT_SC(nn.Module):
    def __init__(self, ETE_dim, ETN_dim, NTG_dim, node, lamda, SE, dropout):
        super(MB_GAT_SC, self).__init__()

        self.ETE = ETE(4, ETE_dim, node, lamda, SE)
...
if __name__ == '__main__':
    ...
    # Batch size = 4, Channels = 4, Height = 164, Width = 164
    dummy_input = torch.randn(4, 4, 164, 164)
