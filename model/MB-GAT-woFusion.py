"""
MB-GAT-woFusion: Multi-modal Brain Graph Attention Network without Fusion
...
class MB_GAT_woFusion(nn.Module):
    def __init__(self, ETE_dim, ETN_dim, NTG_dim, node, lamda, SE, dropout):
        super(MB_GAT_woFusion, self).__init__()
